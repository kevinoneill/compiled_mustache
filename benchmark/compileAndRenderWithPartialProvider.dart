...
class NoPartialsBenchmark extends BenchmarkBase {
  ...
  void run() {
    var out = compile(noVars).renderWithPartialProvider({}, pp);
  }
}
...
class SmallPartialsBenchmark extends BenchmarkBase {
  ...
  void run() {
    var out = compile(small).renderWithPartialProvider({}, pp);
  }
}
...
class LargePartialsBenchmark extends BenchmarkBase {
  ...
  void run() {
    var out = compile(large).renderWithPartialProvider({}, pp);
  }
}
...
class GiantPartialsBenchmark extends BenchmarkBase {
  ...
  void run() {
    var out = compile(giant).renderWithPartialProvider({}, pp);
  }
}
